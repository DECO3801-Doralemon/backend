...
class Ingredient(models.Model):
    ...
    photo = models.ImageField(upload_to='ingredients',
                              default='ingredients/test_photo.PNG')
...
class RecipeIngredient(models.Model):
    ...
    kg_used = models.FloatField(default=1)
...
class Recipe(models.Model):
    author = models.ForeignKey(
        Customer, on_delete=models.CASCADE, related_name='author')
    time_created = models.DateTimeField(auto_now_add=True)
    name = models.CharField(max_length=100)
    tags = models.ManyToManyField(Tag)
    recipe_ingredients = models.ManyToManyField(RecipeIngredient)
    photo = models.ImageField(
        upload_to='recipes', default='recipes/test_photo.PNG')
    steps = models.TextField(max_length=1000)
    customers_who_save = models.ManyToManyField(
        Customer, related_name='customers_who_saved')
